...
export default class StoryScreen extends Component {
  ...
  // Função para iniciar a leitura em voz alta (Text-to-Speech)  ATIVIDADE DO ALUNO
            ...
            <ScrollView style={styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                ...
                <View style={styles.iconContainer}>
                  {/* Ícone do alto-falante para iniciar/parar a leitura em voz alta ATIVIDADE DO ALUNO*/}
